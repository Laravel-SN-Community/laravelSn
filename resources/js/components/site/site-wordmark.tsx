...
export default function SiteWordmark({ logoSize = 'md' }: Props) {
        ...
        <span className="flex items-center gap-2.5">
            ...
            <span className="flex flex-col gap-[3px]">
                <svg
                    ...
                    className={`${s.mark} transition-colors duration-150 ease-out`}
                ...
                <span
                    className={`${s.sub} flex w-full justify-between leading-none font-black uppercase`}
                    style={{ color: 'var(--sn-accent)' }}
                >
                    {Array.from('Sénégal').map((char, i) => (
